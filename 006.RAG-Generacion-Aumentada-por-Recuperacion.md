# Guía Técnica Definitiva: Generación Aumentada por Recuperación (RAG)
...
* **Embedding Models:** Modelos de redes neuronales profundas (como `text-embedding-3-large` o variantes *open-source* basadas en BERT/Bi-Encoders) que transforman texto en vectores densos de alta dimensionalidad (v.g., 1536 dimensiones) que capturan el significado semántico del contenido.
...
* **Large Language Models (LLMs):** El motor cognitivo final (v.g., GPT-4o, Claude 3.5 Sonnet, Llama 3) que procesa el contexto consolidado e instruido mediante ingeniería de prompts para generar respuestas naturales y precisas.
...
graph LR
    ...
    style VectorDB fill:#7724ED,stroke:#333,stroke-width:3px
...
* **Document Loaders & Splitters:** Componentes lógicos distribuidos en servidores de procesamiento (e.g., microservicios en Kubernetes o AWS Lambda). Deben manejar de manera eficiente el análisis (*parsing*) sintáctico de formatos complejos como tablas incrustadas en PDFs.
