...
5.  **Iteración:** El Cerebro evalúa el resultado y decide si la tarea ha terminado o si requiere un nuevo paso.
    ...
    ![Descripción de la imagen](img/001.1.flujo-de-trabajo.png)

Esta estructura permite que el sistema sea mucho más que una interfaz de preguntas y respuestas, convirtiéndo en un colaborador capaz de gestionar flujos de trabajo de principio a fin.

---
# Estructura de componentes Brain Body Tools

La representación del diagrama de contexto según el patrón **Brain-Body-Tools** (Razonamiento, Memoria y Acción), determina la conexión entre los principales componentes:


![Descripción de la imagen](img/001.2.Arquitectura-Brain-Body-Tools.png)
...
- Repositorio [AI-Agent-Architecture](https://github.com/devhadson/AI-Agent-Architecture)
- Disponible como curso en [Hadson.Tech](https://hadson.tech/cursos-disponibles/ai-agent-architecture)
